# Manual de Usuario - Portal SequitoWeb

Bienvenido al centro de mando digital de **El Séquito del Terror**. Este manual describe cómo navegar y utilizar el portal oficial para maximizar tu eficiencia táctica.

## 1. Navegación Principal

### El Líder
Conoce la historia y estadísticas de **Elnazzareno** (DarckRovert), el arquitecto del ecosistema.
...
- **Discord**: Acceso directo al núcleo de comunicación del clan.
- **Unirse**: Requisitos detallados para nuevos aspirantes. Recuerda que no admitimos debilidad; la disciplina y la letalidad son obligatorias.
